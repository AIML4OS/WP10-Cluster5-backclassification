...
This example notebook provides an example of the model training process using MLflow to register and save the model. The algorithm chosen is a Support Vector Machine, supervised machine learning method using a linear kernel. The learning process includes the following steps:
