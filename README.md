# <img height="18" width="18" src="https://cdn.simpleicons.org/python/00ccff99" /> Example pipeline for automatic back-classification of NACE

This repository provides an example of how to back-classify a standard that has changed. NACE revision 2.1 -> revision 2.0 is provided as an example. For an overview of the processes involved in traininga nd using a back-classification model, go to the [**website for this pipeline**](https://aiml4os.github.io/WP10-Cluster5-backclassification/).
